...
namespace ProjectFormeleMethodes.ConversionEngines
{
    public class NDFAtoDFAEngine
    {
        ...
        private static Automata<string> finaliseConversion(Automata<string> merged)
        {
        ...
        private static bool CheckExistingRouteForChar(string currentState, char symbol, Automata<string> dfa)
        {
        ...
        public static Automata<string> Reverse(Automata<string> automaat)
        {
